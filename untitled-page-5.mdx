...
flowchart TD
    ...
    D --> E["Trivesta Global Allocation Fund"]
...
| Underlying Fund | Trivesta Global Allocation Fund | Private Hong Kong OFC fund providing the principal investment exposure |
| Underlying Investment Manager | Trivesta Capital Management | Portfolio management and investment oversight for the sub-fund |
| Underlying Administrator | Apex Fund Services Limited | Fund administration and NAV-related functions under the governing agreements |
| Underlying Custodians Named in the PPM | DBS Bank Ltd; <br />Interactive Brokers Limited | Custody and related services for the OFC structure, subject to the governing agreements |
| Underlying Auditor | OOP CPA & Co. | Auditor of the OFC |
| Hong Kong Legal Adviser | Rowdget W. Young & Co. | Legal adviser to the OFC |
