...
<Warning>
  Before launch, BVI counsel should provide a written classification of GAIN and confirm every licence, registration, recognition, approval or exemption required for Allocofi Limited's issuance, strategy management, token operations and distribution model. No statement on this page should be read as confirmation that such status has already been obtained.
</Warning>
